...
$(document).ready(function() {
    ...
    var map = L.map('map').setView([-76.937325256405998, 5.937144550082488], 4);
    ...
    // var mapDepto = L.geoJson("json/municipiosChocoPoligonos.geojson",{style: mcipio_style}).addTo(map);
 ...
 //    var mapPoint = L.geoJson(readJSON("../meta/json/meta.min.json"), {
